...
public class ButtonCss {
    ...
    public ButtonCss(Integer num){
        ...
        this.input="<input readonly type='text' id='num' value='"+num+"' style='margin: 0; padding: 0; width: 48px; height: 26px;font-size: 16px; line-height: 26px; text-align: center; color: #666; border: 1px solid #ccc; outline: 0; background: #FFF;'>";
    }
}
